...
const DEFAULT_BINARY = 'C:\\Users\\' + process.env.USERNAME + '\\AppData\\Local\\Programs\\Antigravity\\resources\\app\\extensions\\antigravity\\bin\\language_server_windows_x64.exe';
...
export async function ensureLs(proxy = null) {
  ...
  const dataDir = `C:\\Users\\${process.env.USERNAME}\\.windsurf-data\\${key}`;
  try { execSync(`mkdir "${dataDir}\\db"`, { stdio: 'ignore' }); } catch {}
